...
static void LU_decompose(
  ...
  for(i=0; i<m; i++) {
    ...
    __m512i inv512  = _mm512_broadcastw_epi16(inv128) ;

    int kk = (((c+1)/sizeof(__m256i))+(((c+1)%sizeof(__m256i))?1:0)) * sizeof(__m256i) ;

    for(k = c+1; k < kk; k++) EQN(i,k) = Fq_mul(inv, EQN(i,k)) ;
    for(       ; k < m ; k += sizeof(__m256i)){
      __m256i e256 = _mm256_load_si256((__m256i*)&EQN(i,k)) ;
      __m512i e512 = _mm512_cvtepu8_epi16(e256) ;
      __m512i r512 = _m512i_Fq_mul(inv512,e512) ;
                     _mm512_mask_cvtusepi16_storeu_epi8((__m256i*)&EQN(i,k), 0xFFFFFFFF, r512) ;
/*
...
*/
    ...
    for(j=i+1; j<m; j++) {
      ...
      __m512i mul512  = _mm512_broadcastw_epi16(mul128) ;
      ...
      for(       ; k < m ; k += sizeof(__m256i)){
        __m256i e256 = _mm256_load_si256((__m256i*)&EQN(i,k)) ;
        __m512i e512 = _mm512_cvtepu8_epi16(e256) ;
        __m512i r512 = _m512i_Fq_mul(mul512,e512) ;
        __m256i s256 = _mm256_load_si256((__m256i*)&EQN(j,k)) ;
        __m512i s512 = _mm512_cvtepu8_epi16(s256) ;
        __m512i t512 = _m512i_Fq_sub(s512,r512) ;
                       _mm512_mask_cvtusepi16_storeu_epi8((__m256i*)&EQN(j,k), 0xFFFFFFFF, t512) ;
/*
